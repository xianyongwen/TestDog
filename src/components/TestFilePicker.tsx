...
export default function TestFilePicker({ projectId, value, onChange, onUploaded, disabled = false, compact = false, refreshKey = 0 }: {
  projectId?: string | null; value?: string[]; onChange?: (ids: string[]) => void; onUploaded?: (file: TestFileInfo) => void; disabled?: boolean; compact?: boolean; refreshKey?: number;
}) {
