...
const PALETTES = {
  ...
  dark: {
    ...
    link: '#1677FF',
    textPrimary: '#DCE4F0',
    menuTextColor: '#DCE4F0',
    // 渐变侧栏上使用浅蓝文字，避免品牌蓝与选中背景对比不足。
    menuSelectedColor: '#D6E8FF',
  ...
  return {
    ...
    components: {
      ...
      Menu: {
        ...
        itemHoverColor: 'var(--tk-text-nav-hover)',
        itemHoverBg: 'var(--tk-bg-nav-hover)',
        ...
        itemSelectedColor: p.menuSelectedColor,
        itemBorderRadius: 10,
        itemHeight: 46,
        itemMarginInline: 8,
