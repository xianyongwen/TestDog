...
![TestDog 主流程演示](doc/docs/public/images/main-demo.gif)
...
- **上传、滚动与作用域编辑**：项目测试文件保留原始字节，随 `.testcase` 打包导入导出；支持页面/容器滚动与滚入目标元素；步骤表可添加、编辑、拾取和删除父作用域。用例生成 skill 同步提供字段规范与完整示例。
