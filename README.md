...
![TestDog main flow demo](doc/docs/public/images/main-demo.gif)
...
- **Upload, scroll and scoped locators**: preserve original project test files and package them in portable `.testcase` exports; replay page/container scrolling or scroll an element into view; add, edit, pick and remove parent scope in the step table. The generate-testcase skill includes matching schemas and examples.
